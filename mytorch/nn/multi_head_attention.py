...
class MultiHeadAttention:
    def __init__(self, embed_dim, num_heads):
        ...
        # Initialize attention and linear layers
    ...
    def _merge_masks(self, key_padding_mask, attn_mask):
        # Initialize combined mask as None
        combined_mask = None
    ...
    def _split_heads(self, x):
        ...
        new_shape = (self.N, -1, self.num_heads, self.head_dim)
    ...
    def _concat_heads(self, x):
        ...
        return np.reshape(x, (self.N, -1, self.embed_dim))